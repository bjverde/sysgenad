...
REM ECHO PHP 8.2.6 and PHPUnit 9.1.4 Simples
C:\wamp64\bin\php\php8.2.6\php.exe C:\wamp64\bin\phpunit\phpunit-9.5.9.phar --colors=auto --bootstrap C:\wamp64\www\adinatiApp\sysgenad\init.php C:\wamp64\www\adinatiApp\sysgenad\app\tests\
